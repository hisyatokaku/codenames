...
class Spymaster(object):
    ...
    def give_clue(self, team, turn_count, top_n):
        ...
        pos_ix = [card.index for card in self.field if card.color == team and card.taken_by == "None"]
        neg_ix = [card.index for card in self.field if card.color != team and card.taken_by == "None"]
